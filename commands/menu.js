...
const COMMAND_METADATA = {
  ...
  gemini: { category: 'user', descriptionFr: 'Envoyer un message à Gemini.', descriptionEn: 'Send a message to Gemini.' },
  mistral: { category: 'user', descriptionFr: 'Envoyer un message à Mistral ou Mixtral.', descriptionEn: 'Send a message to Mistral or Mixtral.' },
  ...
  setprefix: { category: 'owner', descriptionFr: 'Modifier le préfixe des commandes pour ce chat.', descriptionEn: 'Change the command prefix for this chat.' },
  ...
  translate: { category: 'user', descriptionFr: 'Traduire un texte dans une autre langue.', descriptionEn: 'Translate text into another language.' },
  ...
  vision: { category: 'user', descriptionFr: 'Analyser une image avec l’IA.', descriptionEn: 'Analyze an image with AI.' },
